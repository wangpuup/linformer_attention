...
from espnet2.asr_linformer.transformer.attention import MultiHeadedAttention
from espnet2.asr_linformer.transformer.decoder_layer import LinformerDecoderLayer
...
class LinformerTransformerDecoder(BaseTransformerDecoder):
    def __init__(
        self,
        vocab_size: int,
        encoder_output_size: int,
        ...
        self.decoders = repeat(
            num_blocks,
            lambda lnum: LinformerDecoderLayer(
                attention_dim,
